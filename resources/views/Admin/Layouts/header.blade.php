                ...
                <ul class="navbar-nav header-right main-notification">
                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                            <img src="{{\Illuminate\Support\Facades\Auth::user()->profile_picture==null?asset('assets/images/no_image.jpg'):asset(\Illuminate\Support\Facades\Auth::user()->profile_picture)}}" width="20" alt=""/>
