                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form method="POST" action="{{route('add.service')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group">
                                                <Textarea class="form-control" name="service_description" placeholder="Type your message..." >
                                    ...
                                    <div>
                                        <img src="{{asset('assets/images/no_image.jpg')}}" id="new_image" style="height: 90px; width: 90px" alt="">
                                    </div>
